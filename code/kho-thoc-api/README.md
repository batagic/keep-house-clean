...
Contract tương thích `docs/technical/legacy/apps-script-v11.md`:
...
> **Cài đặt:** [docs/technical/dev.md](../../docs/technical/dev.md) · **Vận hành:** [docs/technical/operator.md](../../docs/technical/operator.md)
